...
//! @file
//! Functions to query register information in a p4info object.

#ifndef PI_INC_PI_P4INFO_REGISTERS_H_
#define PI_INC_PI_P4INFO_REGISTERS_H_
...
#endif  // PI_INC_PI_P4INFO_REGISTERS_H_
